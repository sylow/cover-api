...
Rails.application.configure do
  ...
  config.action_cable.mount_path = nil
  config.action_cable.url = "wss://api.jobcraftsman.com/cable"
  config.action_cable.allowed_request_origins = [ "https://jobcraftsman.com",
                                                  "https://www.jobcraftsman.com"]
  ...
  # config.active_job.queue_name_prefix = "cover_api_production"
